...
def gfg():
    ...
    if request.method == "POST":
        ...
        return fromUserToBackend(Gender, Married, Dependents, Education, Employed_Self, ApplicantIncome, CoapplicantIncome, LoanAmount, Loan_Amount_Term, History_Credit)
